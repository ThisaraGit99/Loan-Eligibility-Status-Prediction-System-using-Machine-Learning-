...
function Loanform() {
  ...
  return (
    ...
    <nav className="navbar-reg">
        ...
        <div className="navbar-nav-form">
        <li className="nav-item-logout">
          <button className="btn-logout-form" onClick={handleLogout}>
            Logout
          </button>
        </li>
        </div>
    ...
    <section>
          ...
          <div className="col-md-6">
            ...
            <div className="form-groups">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="form-control"
                placeholder="Enter your Applicant Income"
                required
              />
            </div>
          </div>
          ...
          <div className="col-md-6">
            ...
            <div className="form-groups">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="form-control"
                placeholder="Enter your Co-Applicant Income"
                required
              />
            </div>
          </div>
          ...
          <div className="col-md-6">
            ...
            <div className="form-groups">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="form-control"
                placeholder="Enter your Terms (months)"
                required
              />
            </div>
          </div>
      ...
      {predictionResult !== '' && (
        <div className="alert alert-success mt-3" id="prediction-result">
